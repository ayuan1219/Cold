<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="库存名称" prop="productName">
        <el-input
    ...
    <el-table v-loading="loading" :data="productList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="库存序号" align="center" prop="productId"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="库存名称" prop="productName">
          <el-input v-model="form.productName" placeholder="请输入库存名称"/>
        </el-form-item>
        <el-form-item label="库存重量" prop="weight">
...
<script>
import {addProduct, delProduct, exportProduct, getProduct, listProduct, updateProduct} from "@/api/system/product";
